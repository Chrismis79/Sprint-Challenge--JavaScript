...
dino1 = {
  ...
  roar: function(){
    return `${this.name} says: RAWAAARRRRWARRAARRRRR!!!`
  }
}
dino2 = {
  name:'Stegosaurus',
...
console.log(`${dino1.name} weighs ${dino1.weight}`);

// What was the diet of a velociraptor?
console.log(`${dino3.name} eat a ${dino3.diet} diet.`);

// How long was a stegosaurus?
console.log(`The ${dino2.name} is ${dino3.length} long.`);
...
const sortUniv = universities.sort();
console.log(sortUniv);
...
const unisWithUni = graduates.map((item) =>{
...
*/
const populationTotal = zooAnimals.reduce((accum, curr) => {
